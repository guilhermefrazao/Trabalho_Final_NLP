...
from tools.retrieval.modeling import TextMatchingForBert
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", default="output_model/response_model/bert-base-chinese_cls/", type=str, help="sbert or prop")
    parser.add_argument("--max_sequence_length", default=512, type=int, help="sbert or prop")
    parser.add_argument("--input_file", default="../data/response/corpus_test.tsv", type=str, help="input file with raw text")
    parser.add_argument("--output_file", default="indices/response/ct_corpus_test.pt", type=str, help="output file save embeddings")
